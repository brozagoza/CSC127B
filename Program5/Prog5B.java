/*=======================================================================================================================================
 |   Assignment:  Program #4: PolynomialB
 ...
 |
 |  Description:  This program tests the PolynomialB class that is to be written and included with this file. THe polynomial class includes
 |                severl super cool methods that perform tasks such as evaluating, toString, and more (check that class header for more info)
 |                This is a testing program that should work on all PolynomialB classes alike.
 |                
...
class Prog5B
{
  public static void main (String [] args)
  {
    ...
    PolynomialB test1 = new PolynomialB();
    test1.addTerm(5,2);
    ...
    PolynomialB test2 = new PolynomialB();
    ...
    PolynomialB test3 = new PolynomialB();
    ...
    PolynomialB test4 = new PolynomialB();
    PolynomialB test5 = new PolynomialB();
    ...
    PolynomialB test6 = new PolynomialB();
    test6.addTerm(5,2);
    test6.addTerm(2,1);
    test6.addTerm(10,0);
    ...
    PolynomialB test7 = new PolynomialB();
    if(test7.isEmpty())
      score++;
    else
    ...
    PolynomialB test8 = new PolynomialB();
    test8.addTerm(1,2);
    test8.addTerm(5,1);
    test8.addTerm(10,0);
    ...
    PolynomialB test9 = new PolynomialB();
    test9.addTerm(5,7);
    test9.addTerm(2,-4);
    test9.addTerm(1,0);
    ...
    PolynomialB test10 = test1.replicate();
