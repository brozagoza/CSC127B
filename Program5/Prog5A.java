/*=======================================================================================================================================
 |   Assignment:  Program #5a: Polynomial Revisited
 |       Author:  Alejandro Zaragoza
 |       Course:  CSC 127B
 |
 |       TA/SL :  Ben Gaska
 |   Instructor:  L. McCann
 |     Due Date:  October 15, 2015 9:00pm
 |
 |  Description:  This program tests the PolynomialA class that is to be written and included with this file. THe polynomialA class 
 |                includes several super cool methods that perform tasks such as evaluating, toString, and more 
 |                (check that class header for more info).
 |                This is a testing program that should work on all Polynomial classes alike.
 |                
...
class Prog5A
{
  public static void main (String [] args)
  {
    ...
    if("(3)x^(6) + (5)x^(2)".compareTo(test1.toString()) == 0)
      ...
      System.out.println("Test 2 failed. "+test1.toString());
    ...
    if ("(6)x^(23) + (3)x^(0) - (5)x^(-1)".compareTo( test2.toString()) == 0)
      ...
      System.out.println("Test 3 failed. "+test2.toString());
